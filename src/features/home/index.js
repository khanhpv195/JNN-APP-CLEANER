...
const DashboardScreen = () => {
  ...
  useLayoutEffect(() => {
    navigation.setOptions({
      title: '',
      headerLeft: () => (
        <View style={{/* was: className="py-2 ml-4 rounded-full" */}}>
          <Image source={Logo} />
        </View>
      ),
      headerRight: () => (
        <View style={{/* was: className="flex-row gap-4 mr-4 items-center" */}}>
          <TouchableOpacity style={{/* was: className="py-2 rounded-full" */}}>
            <BellIcon size={30} color={Colors.neutral} />
          </TouchableOpacity>
          <TouchableOpacity style={{/* was: className="py-2 rounded-full" */}} onPress={() => NavigationService.navigate('Settings')}>
      ...
      >
        ...
        <View style={styles.headerContainer}>
          ...
          <TouchableOpacity style={styles.filterButton}>
            ...
            <ChevronRightIcon size={20} color="#000" style={{/* was: className="rotate-90" */}} />
          </TouchableOpacity>
        </View>

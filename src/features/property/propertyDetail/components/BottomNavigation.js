...
const navigatesBtn = ['Overview', 'Detail', 'Checklist', 'Problems', 'Common Problems', 'Notes']

const BottomNavigation = ({ btnIndex, setBtnIndex }) => {
  return (
    <ScrollView horizontal={true} showsHorizontalScrollIndicator={false} className='flex-initial bg-white px-4'>

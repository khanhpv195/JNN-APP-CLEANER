    ...
    return (
        <Modal visible={isVisible} transparent={true} animationType="fade">
            <View className="flex-1 bg-black/90 justify-center items-center">
                <TouchableOpacity
                    className="absolute top-10 right-5 z-10 bg-gray-800/50 rounded-full p-2"
                    onPress={onClose}
                >
                ...
                {imageUrls.length > 1 && (
                    <>
                        {currentIndex > 0 && (
                            <TouchableOpacity
                                className="absolute left-5 bg-gray-800/50 rounded-full p-2"
                        ...
                        {currentIndex < imageUrls.length - 1 && (
                            <TouchableOpacity
                                className="absolute right-5 bg-gray-800/50 rounded-full p-2"
                                onPress={handleNext}
                            >
